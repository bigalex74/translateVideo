...
from translate_video.api.routes.segments import router as segments_router  # ADR-001 Фаза 2
...
app.include_router(segments_router)  # ADR-001 Фаза 2: segments/config/devlog/stats
