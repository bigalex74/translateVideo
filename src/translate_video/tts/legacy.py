...
# Консервативная оценка — лучше чуть медленнее чем обрезать.
_CHARS_PER_SECOND = 14.0

# Запас: укорачиваем если текст длиннее слота на этот коэффициент.
# 1.15 = допускаем 15% превышения (atempo 1.15x потом выровняет).
_OVERFLOW_THRESHOLD = 1.15
