...
class PipelineConfigTest(unittest.TestCase):
    ...
    def test_timing_safe_render_defaults_are_restored(self):
        ...
        self.assertEqual(restored.rewrite_provider_rpm["gemini"], 5.0)
        self.assertEqual(restored.rewrite_provider_cooldown_seconds, 75.0)
        self.assertTrue(restored.rewrite_provider_wait_for_rate_limit)
        self.assertFalse(restored.rewrite_allow_paid_fallback)
