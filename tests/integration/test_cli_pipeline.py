...
class CliPipelineIntegrationTest(unittest.TestCase):
    ...
    def test_run_executes_fake_pipeline_and_status_commands(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(len(run_payload["runs"]), 8)  # voiceover: без ExportSubtitlesStage
            ...
            self.assertEqual(len(status_payload["stage_runs"]), 8)  # voiceover: без ExportSubtitlesStage
