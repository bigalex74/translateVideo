...
import { apiHeaders, preflightVideo, artifactDownloadUrl, getProjectDoctor, getProjectSnapshots, getProjectStatus, rebuildSubtitles, runPipeline, runSegmentAction, saveProjectSegments, patchProjectConfig, cancelPipeline, previewTTS, safariSafeDownload, withApiKeyQuery } from '../api/client';
...
import { StatusPanel } from './workspace/StatusPanel';
        ...
        <div className="workspace-right panel glass-panel">
          ...
          {rightTab === 'status' && (
            <StatusPanel
              ...
              runDoctor={runDoctor}
              continueFromDoctor={continueFromDoctor}
              isRunning={isRunning}
              isDone={isDone}
              snapshots={snapshots}
              selectSegmentsWhere={selectSegmentsWhere}
