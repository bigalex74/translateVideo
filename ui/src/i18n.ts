...
const TEXT: LocaleMap = {
  ru: {
    ...
    'qa.longIssue': 'фраз длиннее 200 символов — возможны проблемы с естественным таймингом',
    'qa.shortIssue': 'сегментов короче 0.3с — голос может не успеть прочитать',
    'qa.degradationFlags': 'Технических предупреждений',
    'qa.flag.translation_empty': 'пустой перевод',
    'qa.flag.translation_fallback_source': 'перевод совпал с исходником',
    'qa.flag.tts_pretrim': 'текст для озвучки был укорочен',
    ...
    'qa.flag.tts_overflow_natural_rate': 'озвучка на естественной скорости длиннее слота',
    ...
    'qa.flag.translation_rewritten_for_timing': 'перевод был сокращён под естественный тайминг',
    'qa.flag.timing_fit_failed': 'перевод не удалось безопасно сократить под тайминг',
    'qa.flag.timing_fit_invalid_slot': 'подгонка тайминга невозможна из-за нулевой длительности сегмента',
    'qa.flag.timeline_shifted': 'реплика мягко сдвинута, чтобы избежать наложения',
    'qa.flag.timeline_shift_limit_reached': 'достигнут лимит сдвига реплики',
    'qa.flag.timeline_audio_extends_video': 'озвучка выходит за длительность видео',
  ...
  en: {
    ...
    'qa.longIssue': 'phrases are longer than 200 characters — natural timing may be difficult',
    'qa.shortIssue': 'segments are shorter than 0.3s — speech may not fit',
    'qa.degradationFlags': 'Technical warnings',
    'qa.flag.translation_empty': 'empty translation',
    'qa.flag.translation_fallback_source': 'translation equals source text',
    'qa.flag.tts_pretrim': 'TTS text was shortened',
    ...
    'qa.flag.tts_overflow_natural_rate': 'natural-speed speech is longer than the slot',
    ...
    'qa.flag.translation_rewritten_for_timing': 'translation was shortened for natural timing',
    'qa.flag.timing_fit_failed': 'translation could not be safely shortened for timing',
    'qa.flag.timing_fit_invalid_slot': 'timing fit is impossible because the segment duration is zero',
    'qa.flag.timeline_shifted': 'line was softly shifted to avoid overlap',
    'qa.flag.timeline_shift_limit_reached': 'line shift limit was reached',
    'qa.flag.timeline_audio_extends_video': 'speech extends beyond the video duration',
