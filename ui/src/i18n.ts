...
const TEXT: LocaleMap = {
  ru: {
    ...
    'workspace.stageProgress': 'Прогресс этапа',
    ...
    'modal.forceNote': '⚠️ Все этапы будут запущены заново. Готовые артефакты и ручные правки перевода будут перезаписаны без возможности восстановления.',
    ...
    'qa.flag.rewrite_provider_used': 'для подгонки тайминга использована облачная модель',
    'qa.flag.rewrite_fallback_used': 'rewrite-роутер перешёл к fallback-провайдеру',
    'qa.flag.rewrite_provider_failed': 'один из rewrite-провайдеров не дал полезный ответ',
    'qa.flag.rewrite_provider_gemini': 'тайминг подогнан через Gemini',
    'qa.flag.rewrite_provider_openrouter': 'тайминг подогнан через OpenRouter',
    'qa.flag.rewrite_provider_aihubmix': 'тайминг подогнан через AIHubMix',
    'qa.flag.rewrite_provider_polza': 'тайминг подогнан через Polza.ai',
    'qa.flag.rewrite_provider_neuroapi': 'тайминг подогнан через NeuroAPI',
    'qa.flag.rewrite_provider_rule_based': 'тайминг подогнан локальным rule-based fallback',
    'qa.flag.translation_llm': 'сегмент переведён LLM-моделью',
    'qa.flag.translation_provider_used': 'для перевода использована облачная модель',
    'qa.flag.translation_provider_gemini': 'перевод выполнен через Gemini',
    'qa.flag.translation_provider_openrouter': 'перевод выполнен через OpenRouter',
    'qa.flag.translation_provider_aihubmix': 'перевод выполнен через AIHubMix',
    ...
    'stage.timing_fit': '⚙️ Подгонка тайминга',
  ...
  en: {
    ...
    'workspace.stageProgress': 'Stage progress',
    ...
    'qa.flag.rewrite_provider_used': 'cloud model was used for timing fit',
    'qa.flag.rewrite_fallback_used': 'rewrite router switched to a fallback provider',
    'qa.flag.rewrite_provider_failed': 'one rewrite provider did not return a useful answer',
    'qa.flag.rewrite_provider_gemini': 'timing was fitted through Gemini',
    'qa.flag.rewrite_provider_openrouter': 'timing was fitted through OpenRouter',
    'qa.flag.rewrite_provider_aihubmix': 'timing was fitted through AIHubMix',
    'qa.flag.rewrite_provider_polza': 'timing was fitted through Polza.ai',
    'qa.flag.rewrite_provider_neuroapi': 'timing was fitted through NeuroAPI',
    'qa.flag.rewrite_provider_rule_based': 'timing was fitted by local rule-based fallback',
    'qa.flag.translation_llm': 'segment was translated by an LLM model',
    'qa.flag.translation_provider_used': 'cloud model was used for translation',
    'qa.flag.translation_provider_gemini': 'translation used Gemini',
    'qa.flag.translation_provider_openrouter': 'translation used OpenRouter',
    'qa.flag.translation_provider_aihubmix': 'translation used AIHubMix',
